...
def main():
    # load in the data:
    scenario = "_primitives" # "_tabletop" or "_full" or _primitives
    with open(ROOT_DIR / f"output/trajectories{scenario}.pkl", "rb") as f:
    ...
    with open(ROOT_DIR / f"output/set_gen{scenario}_X_POS.pkl", "wb") as f:
